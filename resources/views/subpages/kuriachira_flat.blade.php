...
@section('content')
    <section class="px-6 py-10 bg-gray-50" x-data="{ selectedImage: 'https://realestatethrissur.com/uploads/property/34925fa6-9bd8-4d3b-a7bb-27b60f0da90e.jpg' }">
                    ...
                    <div class="max-w-4xl mx-auto ">
                        ...
                        <div>
                            ...
                            <h2 class="text-xl md:text-2xl font-semibold text-gray-900">
                                2BHK (all attached) flat having 1040 SqFt built by reputed builder available near
                                Kuriachira,,Thrissur .
                            ...
                            <p>Apartment facilities include 24 hours Security person, Maintenance staff, Open well &
                                Corporation water
