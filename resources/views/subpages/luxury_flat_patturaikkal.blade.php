...
@section('content')
    <section class="px-6 py-10 bg-gray-50" x-data="{ selectedImage: 'https://realestatethrissur.com/uploads/property/2e0dbb48-1bca-4646-aa79-65693f747b22.jpg' }">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="relative">
                    ...
                    <div class="flex mt-2 gap-2 overflow-x-auto">
                        <template
                            x-for="img in [
     'https://realestatethrissur.com/uploads/property/2e0dbb48-1bca-4646-aa79-65693f747b22.jpg',
            'https://realestatethrissur.com/uploads/property/c14380c2-1e79-492e-b6e9-76ea53c23d5d.jpg',
            'https://realestatethrissur.com/uploads/property/1c47bcfc-0960-4ab4-a6bd-065ac5bca872.jpg',
            'https://realestatethrissur.com/uploads/property/2a7477d6-ef85-4930-b378-403a38d03230.jpg',
            'https://realestatethrissur.com/uploads/property/3336ec1d-747b-415f-aa1f-5dc9039b9b12.jpg',
            'https://realestatethrissur.com/uploads/property/9453ca6c-2676-470d-8470-94dc3ae9440c.jpg',
            'https://realestatethrissur.com/uploads/property/ccaf0694-5e6c-4fc2-9267-d6e611e90930.jpg'
                    ]"
                            :key="img">
                ...
                <div class="mt-6 rounded-2xl border  p-6 md:p-8">
                    <h3 class="text-red-600 font-bold text-lg mb-2">RT5023 </h3>
                    <h2 class="text-2xl font-bold text-gray-900 mb-4">
                        LUXURY FLAT 1745 SQFT 3BHK PATTURAIKKAL, THRISSUR
                    </h2>
                    ...
                    <div class="max-w-4xl mx-auto ">
                        ...
                        <div>
                            ...
                            <h2 class="text-xl md:text-2xl font-semibold text-gray-900">
                                Prime location 3 Bedroom Luxury Flat 1745 SqFt available at Patturaikkal, Thrissur. Approx
                                1.5 KM from
                                Thrissur round, just walk able distance for Thiruvambady temple, 800 meter Devamatha CMI
                                Public School.
                            ...
                            <p class="text-gray-900 font-semibold">
                                Expected price: 1.12 Cr negotiable
                            </p>

                            <!-- Description -->
                            <p class="mt-4 text-gray-700 leading-relaxed">
                                Flat consist of 3 bedrooms, 3 wash rooms, Spacious Living, Dining, kitchen, balcony etc.
                                Quality
                                Construction from reputed builder.

                            </p>
                            <p class="mt-4 text-gray-700 leading-relaxed"> Apartment Amenities: Dedicated car parking slot
                                available,
                                liquid & solid waste management system, 24 hour security, cleaning staff, care taker, lift
                                facility,
                                generator back up.
                            </p>
                            <!-- Amenities -->
                            ...
                            Places in Vicinity: Thiruvambady temple, Devamatha CMI Public School, Bismi hyper market, Aswini
                            Hospital,
                    ...
                    <div class="flex justify-between items-center mt-8">
                        <p class="text-xl font-bold">
                            Rs. <span class="text-red-600">11200000</span>
                        </p>
                        <p class="text-xl font-bold text-red-600">Patturaickal
                        </p>
                    </div>
            ...
            <div class="bg-white rounded-lg shadow-lg p-6 md:h-2/3 ">
                ...
                <form class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" value="RT5023" readonly
