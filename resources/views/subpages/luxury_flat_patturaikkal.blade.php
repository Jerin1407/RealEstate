...
@section('content')
    ...
    x-data="{ selectedImage: 'https://realestatethrissur.com/uploads/property/2e0dbb48-1bca-4646-aa79-65693f747b22.jpg' }">
          ...
          <div class="max-w-4xl mx-auto ">
            ...
            <div>
              ...
              <h2 class="text-xl md:text-2xl font-semibold text-gray-900">
                Prime location 3 Bedroom Luxury Flat 1745 SqFt available at Patturaikkal, Thrissur. Approx 1.5 KM from
                Thrissur round, just walk able distance for Thiruvambady temple, 800 meter Devamatha CMI Public School.
