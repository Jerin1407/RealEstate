...
@section('content')
    <section class="px-6 py-10 bg-gray-50" x-data="{ selectedImage: 'https://www.realestatethrissur.com/uploads/property/a9e7deed-eff4-443a-88f8-d8d962f1c82b_01082024082623.jpg' }">
            ...
            'https://www.realestatethrissur.com/uploads/property/2448dace-e1c5-4442-9de9-6765625813ef_01082024082623.jpg',
                ...
                <section class="bg-white py-10 px-6">
                    <div class="max-w-4xl mx-auto">
                        ...
                        <!-- Vicinity -->
                        <p class="text-gray-700 mb-4">
                            <span class="font-semibold">Places in Vicinity:</span> Amala Medical college, IES School, Banks
                            & ATMs,
                            Public Transport stand, Supermarket & Groceries, Worship places of all religion etc, Bank &
                            ATMs,
                        </p>
