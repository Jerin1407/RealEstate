...
@section('content')
    <section class="px-6 py-10 bg-gray-50" x-data="{ selectedImage: 'https://realestatethrissur.com/uploads/property/dfdfv.jpg' }">
            ...
            'https://realestatethrissur.com/uploads/property/fgfgfcc.jpg'
                ...
                <div>
                    ...
                    <p class="text-gray-700 leading-relaxed mb-4">
                        ...
                        Ground floor - Sitout, formal living area, dining hall, two bedrooms with attached toilet, kitchen,
                        work
                        area.<br>
                    ...
                    <p class="text-gray-700 leading-relaxed mb-4">
                        <strong>Other Highlights:</strong> Flooring completed using stain-free vitrified tiles, open well,
                        compound
