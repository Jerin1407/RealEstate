...
@section('content')
    <section class="px-6 py-10 bg-gray-50" x-data="{ selectedImage: 'https://www.realestatethrissur.com/uploads/property/asaw.jpg' }">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="relative">
                    ...
                    <div class="flex mt-2 gap-2 overflow-x-auto">
                        <template
                            x-for="img in [
     'https://www.realestatethrissur.com/uploads/property/asaw.jpg',
            'https://www.realestatethrissur.com/uploads/property/34343242.jpg',
            'https://www.realestatethrissur.com/uploads/property/343_05082024100247.jpg',
            ]"
                            :key="img">
                ...
                <section class="bg-white py-10 px-6">
                    <div class="max-w-4xl mx-auto">
                        ...
                        <p class="text-red-600 font-bold mb-2">RT5761</p>

                        <!-- Title -->
                        <h2 class="text-xl font-bold text-gray-900 mb-4">
                            WESTFORT 2BHK, 1200SQFT, FURNISHED FLAT FOR RENT
                        </h2>

                        <!-- Key Facts -->
                        <h3 class="text-lg font-semibold text-gray-800 mb-2">Key Facts</h3>
                        <p class="text-gray-700 mb-4">
                            2 BHK (all attached) Fully Furnished flat having 1200 SqFt available near Westfort,
                            Thrissur. Car parking facility prevails.
                        </p>

                        <!-- Rent -->
                        <p class="text-gray-700 mb-4">
                            <span class="font-semibold">Rent:</span> ₹ 20000/- Per month (including maintenance)
                        </p>

                        <!-- Assistance -->
                        <p class="text-gray-700 mb-4">
                            For professional assistance contact <span class="font-semibold">GOD’s OWN Properties Pvt.
                                Ltd</span> @
                        ...
                        <p class="text-gray-700 mb-6">
                            <span class="font-semibold">Our Picture Perfect Authenticity:</span> We make sure that the
                            actual property
            ...
            <div class="bg-white rounded-lg shadow-lg p-6 md:h-5/6">
                ...
                <form class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" value="RT5761" readonly
