...
<section class="px-6 py-10 bg-gray-50"
    x-data="{ selectedImage: 'https://www.realestatethrissur.com/uploads/property/WhatsApp%20Image%202024-02-02%20at%204.00.30%20PM.jpeg' }">
        ...
        <section class="bg-white py-10 px-6">
          <div class="max-w-4xl mx-auto">
            ...
            <div class="text-gray-700 leading-relaxed space-y-4">
              <p>
                Gated community residential land available in a good residential area near Kottekad Mary Matha church,
                Thrissur just 4km off from Thrissur-Shornur highway and 6km (10min drive) away from Thrissur town. Easy
                accessibility from multiple roads to this great location. You can reach this location via
                Thrissur-Viyyur Kottekad road or you can access Pookunnam MLA road while coming from Thrissur town. From
                Kunnamkulam or Guruvayur if you travelling then you can reach this location via Mundur – Kottekad main
                road and also people from Wadakancherry or Shornur can reach here through Thiroor-Kottekad road.
              </p>

              <p>
                Institutions like Bharthiya Vidhya Mandhir CBSE School, Parmakavu Vidhya Mandhir, Westfort Higher
                education Academy, Chinmaya School & College, Vimala College, Thrissur Govt. Menical College & Amala
                Medical college, Govt. Engineering college all are reachable in 10mins drive from this property.
              </p>

              <p>
                All basic essentials like Temple, Church, Mosque, Supermarket, Bank & ATMs, Grocery shop, Health
              ...
              <p>
                <span class="font-semibold">Asking Price:</span> For this Gated community land ₹ 4.10 lakh per cent
              </p>
