...
<section class="px-6 py-10 bg-gray-50"
    x-data="{ selectedImage: 'https://realestatethrissur.com/uploads/property/e434.jpg' }">
      ...
      <div class="lg:col-span-2 space-y-6">
        ...
        <div class="relative">
          ...
          <div class="flex mt-2 gap-2 overflow-x-auto">
            ...
            'https://realestatethrissur.com/uploads/property/e434.jpg',
            'https://realestatethrissur.com/uploads/property/454545.jpg',
            'https://realestatethrissur.com/uploads/property/54545_07082024124141.jpg',
            'https://realestatethrissur.com/uploads/property/rerw.jpg',
            'https://realestatethrissur.com/uploads/property/er42342.jpg',
            'https://realestatethrissur.com/uploads/property/er242.jpg'
          ]" :key="img">
        ...
        <div>
          <h3 class="text-red-600 font-bold text-lg mb-2">RT5771</h3>
          <h2 class="text-2xl font-bold text-gray-900 mb-4">
            KOORKENCHERY 4BHK,2260SQFT, 6CENT ,VILLA THRISSUR
          </h2>

          <h4 class="text-lg font-semibold text-gray-700 mb-2">Property Description</h4>
          <p class="text-gray-700 leading-relaxed mb-4">
            Ready to occupy 2260 SqFt 4 bedroom near Koorkenchery, Thrissur. Land area - 6 cent.
          ...
          <p class="text-gray-700 leading-relaxed mb-4">
            ...
            Ground floor- Sitout, living area, dining hall, two bedrooms with attached Washrooms, one common washroom,
            kitchen, work area with smokeless stove, exists. High quality Kitchen cabinets & wardrobes work completed
            with necessary light fitting arrangements. <br>

            First floor � Living area, Two bedrooms with attached Washroom, one balcony and open terrace.
          </p>

          <p class="text-gray-700 leading-relaxed mb-4">
            <strong>Other Highlights:</strong> Flooring completed using Stain free vitrified tiles, Compound wall with
            gate, Open well. Sufficient Water At All Seasons . All basic facilities available in walk able distance.
          </p>
          <p class="text-gray-700 mb-2"><span class="font-semibold">Asking Price</span> � 1.25 Cr (negotiable)</p>
          ...
          <p class="text-gray-700 mb-4">Loan facility with flexible & lowest interest rates available from all leading
            Banks. </p>
          <p class="mb-6">
