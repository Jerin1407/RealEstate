...
@section('content')
    <section class="px-6 py-10 bg-gray-50" x-data="{ selectedImage: 'https://realestatethrissur.com/uploads/property/e434.jpg' }">
        <div class="max-w-7xl mx-auto grid lg:grid-cols-3 gap-8">
            ...
            'https://realestatethrissur.com/uploads/property/er242.jpg'
                ...
                <div>
                    ...
                    <p class="text-gray-700 leading-relaxed mb-4">
                        <strong>Other Highlights:</strong> Flooring completed using Stain free vitrified tiles, Compound
                        wall with
