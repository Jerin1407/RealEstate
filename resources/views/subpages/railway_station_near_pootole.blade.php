...
@section('content')
    <section class="px-6 py-10 bg-gray-50" x-data="{ selectedImage: 'https://www.realestatethrissur.com/uploads/property/544.jpg' }">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="relative">
                    ...
                    <div class="flex mt-2 gap-2 overflow-x-auto">
                        <template
                            x-for="img in [
     'https://www.realestatethrissur.com/uploads/property/544.jpg',
            'https://www.realestatethrissur.com/uploads/property/ewewe_30082024120719.jpg',
            ]"
                            :key="img">
                ...
                <section class="bg-white py-10 px-6">
                    <div class="max-w-4xl mx-auto">
                        ...
                        <!-- Property ID -->
                        <p class="text-red-600 font-bold mb-2">RT5820</p>

                        <!-- Title -->
                        <h2 class="text-xl font-bold text-gray-900 mb-4">
                            RAILWAY STATION NEAR COMMERCIAL VILLA FOR RENT, THRISSUR
                        </h2>
                        ...
                        <!-- More listings -->
                        <p class="text-gray-700 mb-4">
                            Search More Villa / Flats @ <a href="https://www.realestatethrissur.com"
                                class="text-blue-600 underline">www.realestatethrissur.com</a>
                        </p>

                        <!-- Address -->
                        <p class="text-gray-700 mb-6">
                            GOD’s OWN Properties & Developers Pvt. Ltd., Ground Floor, N.P.Tower, Guruvayur Road, Westfort,
                            Thrissur
                        </p>
            ...
            <div class="bg-white rounded-lg shadow-lg p-6 md:h-5/6">
                ...
                <form class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" value="RT5820" readonly
