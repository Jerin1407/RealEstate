...
<section class="px-6 py-10 bg-gray-50"
    x-data="{ selectedImage: 'https://www.realestatethrissur.com/uploads/property/544.jpg' }">
     ...
     'https://www.realestatethrissur.com/uploads/property/544.jpg',
        ...
        <section class="bg-white py-10 px-6">
          <div class="max-w-4xl mx-auto">
            ...
            <!-- Assistance -->
            <p class="text-gray-700 mb-4">
              For Professional assistance and for Better Deals contact <span class="font-semibold">GOD’s OWN Properties
                Pvt. Ltd</span> @
