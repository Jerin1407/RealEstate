...
@section('content')
    <section class="px-6 py-10 bg-gray-50" x-data="{ selectedImage: 'https://realestatethrissur.com/uploads/property/432323.jpg' }">
            ...
            'https://realestatethrissur.com/uploads/property/erere_07082024125042.jpg'
                ...
                <div>
                    ...
                    <p class="text-gray-700 leading-relaxed mb-4">
                        ...
                        Ground floor: Sitout, Formal living area, Dining Area, 2 washroom attached bedrooms, Kitchen, work
                        area
                    ...
                    <p class="text-gray-700 leading-relaxed mb-4">
                        <strong>� Places in Vicinity:</strong> Amala Medical college, IES School, Banks & ATMs, Public
                        Transport
