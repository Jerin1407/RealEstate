...
@section('content')
    <section class="px-6 py-10 bg-gray-50" x-data="{ selectedImage: 'https://www.realestatethrissur.com/uploads/hotproperties/470f452d-1440-4fa8-a544-d593c447a9fd.jpg' }">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="relative">
                    ...
                    <div class="flex mt-2 gap-2 overflow-x-auto">
                        <template
                            x-for="img in [
     'https://www.realestatethrissur.com/uploads/hotproperties/470f452d-1440-4fa8-a544-d593c447a9fd.jpg',
            ]"
                            :key="img">
