...
<head>
    ...
    <title>List Property | Real Estate Thrissur</title>
                ...
                <div class="bg-primary text-white px-6 py-4">
                    <div class=" md:flex justify-between items-center">
                        ...
                        <div class="flex items-center space-x-4">
                            <form method="GET" action="{{ route('filterRequestProperty') }}"
                                ...
                                <tr class="border-b border-gray-200 hover:bg-gray-50">
                                    ...
                                    <td class="px-4 py-3 text-sm text-gray-900">
                                        <div class="flex items-center gap-3">
                                            ...
                                            <!-- View -->
                                            <a href="{{ route('viewRequest', $property->property_id) }}">
                                                <i class="fa-solid fa-eye cursor-pointer hover:text-green-600"></i>
                                            </a>

                                            <!-- Delete -->
                                            <form action="{{ route('deleteRequest', $property->property_id) }}"
